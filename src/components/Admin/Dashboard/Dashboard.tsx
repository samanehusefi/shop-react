...
const Dashboard = () => {
  ...
  const { circleBadge } = useSelector((state: RootState) => state.circleBadge);
  ...
  return (
    <div className="w-full min-w-0">
      ...
      <div className="mt-5 grid grid-cols-1 gap-4 sm:mt-6 sm:gap-5 lg:gap-6 xl:grid-cols-3">
        ...
        <div className="rounded-xl bg-white p-4 shadow-sm sm:p-5">
          ...
          <div className="grid grid-cols-1 gap-3 min-[400px]:grid-cols-2">
            <button
              ...
              className="rounded-lg bg-green-50 p-3 text-right transition hover:-translate-y-0.5 hover:shadow-sm sm:p-4"
            >
              <p className="text-xs text-gray-500">محصولات موجود</p>
            ...
            <button
              ...
              className="rounded-lg bg-red-50 p-3 text-right transition hover:-translate-y-0.5 hover:shadow-sm sm:p-4"
            >
              <p className="text-xs text-gray-500">محصولات ناموجود</p>
